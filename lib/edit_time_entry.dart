...
class _EditEntryState extends State<EditEntry> {
  ...
  late TextEditingController _addtionalInfocontroller;
                            ...
                            child: CalendarCarousel<Event>(
                              onDayPressed: (date, events) {
                                setState(() {
                                  _currentDate2 = date;
                                  selected =
                                      DateFormat.yMMMd().format(_currentDate2);
...
//      firstDayOfWeek: 4,
                      ...
                      children: [
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (val) => _projectcontroller.text.isEmpty
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            filled: true,
                            hintStyle: TextStyle(color: textColor),
                            hintText: widget.additionalInfo),
                      ),
                    ),
                  ],
                ),
  ...
  _getTimeFromUser({bool? isStartTime}) async {
    ...
    if (_pickedTime == null)
      ...
      setState(() {
        widget.startTime = _formatedTime;
      });
    else if (!isStartTime) {
      setState(() {
        widget.endTime = _formatedTime;
      });
      //_compareTime();
    }
  }
